function [NormC] = RightMoveLst(CR, A, B)
...
T8 = reshape(ncon({conj(B{1,2}), A{1,2}}, {[1,-1,-3,-5], [1,-2,-4,-6]), [1]),[D2,D2,D2]);
...
T4 = reshape(ncon({conj(B{1,5}), A{1,5}}, {[1,-1,-3,-5], [1,-2,-4,-6]}, [1]),[D2,D2,D2]);
...
NormC = ncon([CR, Cu, Cd], ([1,2], [1,3], [3,2]), [1,2,3]);
