function [NormM] = Get_Fig3c_Weight17_Part2(A, theta)
...
Id = [57,58,60,53,59,62,42,54];
Os = {Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[CL] = MergeLeftStringOp(CL0, AL, A0)*cf;   %1

cf = -cos(theta)*sin(theta)^5;
Id = [57,58,59,53,54,62];
Os = {Sx,Sx,Sx,Sy,Sy,Sy};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %2
CL = CL + tCL*cf;

cf = -cos(theta)^2*sin(theta)^4;
Id = [38,53,57,58,59,54,62,39];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %3
CL = CL + tCL*cf;

cf = -cos(theta)^2*sin(theta)^4;
Id = [54,57,58,59,42,53,62,41,43];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %4
CL = CL + tCL*cf;

cf = -cos(theta)^2*sin(theta)^4;
Id = [42,57,58,60,53,59,62,41,43];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
Id = [38,53,54,57,58,59,42,62,39,41,43];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %6
CL = CL + tCL*cf;

cf = -cos(theta)^3*sin(theta)^3;
Id = [38,42,53,57,58,60,59,62,39,41,43];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^2*sin(theta)^4;
Id = [38,53,57,58,60,59,62,39,42,54];
...
cf = -sin(theta)^6;
Id = [57,58,60,53,54,59,62,61];
Os = {Sx,Sx,Sx,Sy,Sy,Sy,Sy,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %9
CL = CL + tCL*cf;

cf = -cos(theta)*sin(theta)^5;
Id = [38,53,57,58,60,54,59,62,39,61];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %10
CL = CL + tCL*cf;

cf = -cos(theta)^3*sin(theta)^3;
Id = [42,57,58,59,53,62,41,43,61];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %11
CL = CL + tCL*cf;

cf = -cos(theta)*sin(theta)^5;
Id = [54,57,58,60,42,53,59,62,41,43,61];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %12
CL = CL + tCL*cf;

cf = -cos(theta)^4*sin(theta)^2;
Id = [38,42,53,57,58,59,62,39,41,43,61];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %13
CL = CL + tCL*cf;

cf = -cos(theta)^2*sin(theta)^4;
Id = [38,53,54,57,58,60,42,59,62,39,41,43,61];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %14
CL = CL + tCL*cf;

cf = cos(theta)^2*sin(theta)^4;
Id = [57,58,59,53,62,42,54,61];
Os = {Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %15
CL = CL + tCL*cf;

cf = cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,59,62,39,42,54,61];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %16
CL = CL + tCL*cf;

cf = cos(theta)*sin(theta)^5;
Id = [57,58,60,53,54,59,62,63];
Os = {Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^2*sin(theta)^4;
Id = [38,53,57,58,60,54,59,39,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^4*sin(theta)^2;
Id = [42,57,58,59,53,41,43,62,63];
Os = {Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %19
CL = CL + tCL*cf;

cf = cos(theta)^2*sin(theta)^4;
Id = [54,57,58,60,42,53,59,41,43,62,63];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %20
CL = CL + tCL*cf;

cf = cos(theta)^5*sin(theta);
Id = [38,42,53,57,58,59,39,41,43,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %21
CL = CL + tCL*cf;

cf = cos(theta)^3*sin(theta)^3;
Id = [38,53,54,57,58,60,42,59,39,41,43,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %22
CL = CL + tCL*cf;

cf = -cos(theta)^3*sin(theta)^3;
Id = [57,58,59,53,42,54,62,63];
...
cf = -cos(theta)^4*sin(theta)^2;
Id = [38,53,57,58,59,39,42,54,62,63];
...
cf = cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,59,54,39,61,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^3*sin(theta)^3;
Id = [54,57,58,59,42,53,41,43,61,62,63];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %27
CL = CL + tCL*cf;

cf = cos(theta)^3*sin(theta)^3;
Id = [42,57,58,60,53,59,41,43,61,62,63];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^4*sin(theta)^2;
Id = [38,53,54,57,58,59,42,39,41,43,61,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %29
CL = CL + tCL*cf;

cf = cos(theta)^4*sin(theta)^2;
Id = [38,42,53,57,58,60,59,39,41,43,61,62,63];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^2*sin(theta)^4;
Id = [57,58,60,53,59,42,54,61,62,63];
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,60,59,39,42,54,61,62,63];
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,60,63,54,59,39,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,59,62,54,63,39,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^5*sin(theta);
Id = [42,57,58,59,63,53,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [54,57,58,60,63,42,53,59,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %38
CL = CL + tCL*cf;

cf = -cos(theta)^3*sin(theta)^3;
Id = [54,57,58,59,62,42,53,63,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [42,57,58,60,62,53,59,63,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^6;
Id = [38,42,53,57,58,59,63,39,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %41
CL = CL + tCL*cf;

cf = -cos(theta)^4*sin(theta)^2;
Id = [38,53,54,57,58,60,63,42,59,39,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %42
CL = CL + tCL*cf;

cf = -cos(theta)^4*sin(theta)^2;
Id = [38,53,54,57,58,59,62,42,63,39,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^4*sin(theta)^2;
Id = [38,42,53,57,58,60,62,59,63,39,41,43,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^2*sin(theta)^4;
Id = [57,58,60,62,53,59,63,42,54,64,73];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^5*sin(theta);
Id = [38,53,57,58,59,63,39,42,54,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^3*sin(theta)^3;
Id = [38,53,57,58,60,62,59,63,39,42,54,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)*sin(theta)^5;
Id = [57,58,60,62,53,54,59,63,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sy,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^4*sin(theta)^2;
Id = [38,53,57,58,59,63,54,39,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^2*sin(theta)^4;
Id = [38,53,57,58,60,62,54,59,63,39,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sy,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^4*sin(theta)^2;
Id = [54,57,58,59,63,42,53,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %53
CL = CL + tCL*cf;

cf = -cos(theta)^4*sin(theta)^2;
Id = [42,57,58,60,63,53,59,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^4*sin(theta)^2;
Id = [42,57,58,59,62,53,63,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^2*sin(theta)^4;
Id = [54,57,58,60,62,42,53,59,63,41,43,61,64,73];
...
cf = -cos(theta)^5*sin(theta);
Id = [38,53,54,57,58,59,63,42,39,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
[tCL] = MergeLeftStringOp(CL0, AL, A0);   %57
CL = CL + tCL*cf;

cf = -cos(theta)^5*sin(theta);
Id = [38,42,53,57,58,60,63,59,39,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^5*sin(theta);
Id = [38,42,53,57,58,59,62,63,39,41,43,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^3;
Id = [38,53,54,57,58,60,62,42,59,63,39,41,43,61,64,73];
...
cf = cos(theta)^3*sin(theta)^3;
Id = [57,58,60,63,53,59,42,54,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^3*sin(theta)^3;
Id = [57,58,59,62,53,63,42,54,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sy,Sy,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^4*sin(theta)^2;
Id = [38,53,57,58,60,63,59,39,42,54,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = cos(theta)^4*sin(theta)^2;
Id = [38,53,57,58,59,62,63,39,42,54,61,64,73];
Os = {Sx,Sx,Sx,Sx,Sx,Sx,Sy,Sz,Sz,Sz,Sz,Sz,Sz};
[AL] = UpdateLeftTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^2;
Id = [76,77,78,79,80,91];
Os = {Sx,Sx,Sz,Sz,Sz,Sz};
[AR] = UpdateRightTensors(Id, Os, A, A0);
...
cf = -cos(theta)^3*sin(theta)^2;
Id = [79,80,76,77,78,81,92];
Os = {Sx,Sy,Sz,Sz,Sz,Sz,Sz};
[AR] = UpdateRightTensors(Id, Os, A, A0);
...
cf = cos(theta)^3*sin(theta)^2;
Id = [76,77,79,80,81,91,92];
Os = {Sx,Sx,Sx,Sy,Sz,Sz,Sz};
[AR] = UpdateRightTensors(Id, Os, A, A0);
[tCR] = MergeRightStringOp(CR0, AR, A0);   %14
CR = CR + tCR*cf;

cf = cos(theta)^4*sin(theta);
Id = [76,77,80,78,81,91,92];
Os = {Sx,Sx,Sx,Sz,Sz,Sz,Sz};
[AR] = UpdateRightTensors(Id, Os, A, A0);
[tCR] = MergeRightStringOp(CR0, AR, A0);   %15
CR = CR + tCR*cf;

cf = -cos(theta)^4*sin(theta);
Id = [79,76,80,78,81,91,92];
Os = {Sx,Sy,Sy,Sz,Sz,Sz,Sz};
[AR] = UpdateRightTensors(Id, Os, A, A0);
