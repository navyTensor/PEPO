function [A, Td, EvoX, EvoZ] = InitFig3cPEPS(theta, depth)
% A[m,u,l,d,r], Uz = (Rz)^{+}, Ux = (Rx)^{+}
% Ostring = X_{37,41,52,56,57,58,62,79}Y_{75}Z_{38,40,42,63,72,80,90,91}
...
Xd3 = reshape(ncon({conj(T0{3}),T0{3}, Sx}, {[-1,1,-3,-5,-7], [-2,2,-4,-6,-8], [1,2]}, [1,2]),[4,4,4,4]);
...
% Ostring = X_{37,41,52,56,57,58,62,79}Z_{38,40,42,63,72,80,90,91}Y_{75}
for i = [37,52,56,57]
    A{i+1} = Xd2;
end
for i = [41,58,62,79]
